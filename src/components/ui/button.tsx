  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-button text-white shadow-button hover:scale-105 hover:shadow-glow border-0 font-semibold tracking-wide",
        brand: "bg-brand-primary text-white shadow-button hover:bg-brand-primary/90 hover:scale-105 border-0 font-semibold",
        outline_brand: "border border-brand-primary text-brand-primary bg-transparent hover:bg-brand-primary hover:text-white font-semibold",
      },
      size: {
